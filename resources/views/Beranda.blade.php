    ...
    <div class="mt-16 flex flex-1">
        ...
        <div class="flex w-full flex-col items-center py-10" id="school-list">
            ...
            @foreach ($schools as $school)
                <div
                    class="school-box group mb-4 flex w-4/5 items-center justify-between rounded-lg border-2 border-slate-200 bg-white p-6 shadow-sm transition-all duration-300 hover:border-blue-300 hover:shadow-md">
                    <div class="flex items-center gap-6">
                        <div
                            class="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-lg border border-gray-100 bg-gray-50 p-2">
                        ...
                        <div class="text-sm text-gray-700">
                            ...
                            <p class="mb-1 flex items-center gap-2"><span class="font-semibold">Alamat:</span>
                                {{ $school->location }}</p>
                            <p class="flex items-center gap-2"><span class="font-semibold">Jumlah porsi:</span> <span
                                    class="rounded-full bg-blue-100 px-2 py-0.5 text-xs font-bold text-blue-800">{{ $school->total_meal }}</span>
                            </p>
                        </div>
                    </div>

                    <button
                        class="checkmark-btn rounded-full p-2 transition-transform hover:scale-110 hover:bg-green-50 focus:outline-none">
